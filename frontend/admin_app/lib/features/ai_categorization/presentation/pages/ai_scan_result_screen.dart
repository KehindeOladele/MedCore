...
/// Camera capture & review screen for AI Categorization.
/// Uses plain Navigator (no GoRouter) — mirrors patient_app exactly.
              ...
              onTap: () {
                setState(() {
                  ...
                  if (_capturedImages.isEmpty) {
                    _selectedIndex = 0;
                  } else if (_selectedIndex >= _capturedImages.length) {
                    _selectedIndex = _capturedImages.length - 1;
