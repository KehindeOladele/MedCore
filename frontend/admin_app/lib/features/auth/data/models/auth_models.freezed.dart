...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SignupRequest&&(identical(other.email, email) || other.email == email)&&(identical(other.password, password) || other.password == password));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SignupRequest&&(identical(other.email, email) || other.email == email)&&(identical(other.password, password) || other.password == password));
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SignupResponse&&(identical(other.id, id) || other.id == id)&&(identical(other.email, email) || other.email == email)&&(identical(other.role, role) || other.role == role));
}
...
@override
String toString() {
  return 'SignupResponse(id: $id, email: $email, role: $role)';
}
...
class _SignupResponse implements SignupResponse {
  const _SignupResponse({required this.id, required this.email, required this.role});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SignupResponse&&(identical(other.id, id) || other.id == id)&&(identical(other.email, email) || other.email == email)&&(identical(other.role, role) || other.role == role));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UserMeCopyWith<UserMe> get copyWith => _$UserMeCopyWithImpl<UserMe>(this as UserMe, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserMe&&(identical(other.id, id) || other.id == id)&&(identical(other.email, email) || other.email == email)&&(identical(other.role, role) || other.role == role));
}
...
@override
String toString() {
  return 'UserMe(id: $id, email: $email, role: $role)';
}
...
/// @nodoc
abstract mixin class $UserMeCopyWith<$Res>  {
  factory $UserMeCopyWith(UserMe value, $Res Function(UserMe) _then) = _$UserMeCopyWithImpl;
@useResult
$Res call({
 String id, String email, String role
});
...
/// @nodoc
class _$UserMeCopyWithImpl<$Res>
    implements $UserMeCopyWith<$Res> {
  _$UserMeCopyWithImpl(this._self, this._then);

  final UserMe _self;
  final $Res Function(UserMe) _then;
...
/// Adds pattern-matching-related methods to [UserMe].
extension UserMePatterns on UserMe {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UserMe value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UserMe() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UserMe value)  $default,){
final _that = this;
switch (_that) {
case _UserMe():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UserMe value)?  $default,){
final _that = this;
switch (_that) {
case _UserMe() when $default != null:
return $default(_that);case _:
...
class _UserMe implements UserMe {
  const _UserMe({required this.id, required this.email, required this.role});
  factory _UserMe.fromJson(Map<String, dynamic> json) => _$UserMeFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$UserMeCopyWith<_UserMe> get copyWith => __$UserMeCopyWithImpl<_UserMe>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$UserMeToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UserMe&&(identical(other.id, id) || other.id == id)&&(identical(other.email, email) || other.email == email)&&(identical(other.role, role) || other.role == role));
}
...
/// @nodoc
abstract mixin class _$UserMeCopyWith<$Res> implements $UserMeCopyWith<$Res> {
  factory _$UserMeCopyWith(_UserMe value, $Res Function(_UserMe) _then) = __$UserMeCopyWithImpl;
@override @useResult
$Res call({
 String id, String email, String role
});
...
/// @nodoc
class __$UserMeCopyWithImpl<$Res>
    implements _$UserMeCopyWith<$Res> {
  __$UserMeCopyWithImpl(this._self, this._then);

  final _UserMe _self;
  final $Res Function(_UserMe) _then;

/// Create a copy of UserMe
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? email = null,Object? role = null,}) {
  return _then(_UserMe(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,email: null == email ? _self.email : email // ignore: cast_nullable_to_non_nullable
as String,role: null == role ? _self.role : role // ignore: cast_nullable_to_non_nullable
as String,
